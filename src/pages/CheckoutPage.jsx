          ...
          <div>
            <div className="flex gap-6 mt-8 ">
              ...
              <div>
                ...
                <input
                  className="px-4 py-3 my-4 mb-8 sm:sm:w-[50rem] w-64  border rounded-sm border-black hover:border-2 hover:border-black focus:outline-none"
            ...
            <div className="flex gap-6 mt-8">
              ...
              <div>
                ...
                <div className="sm:flex gap-4">
                  <div>
                  <input
                    className="px-4 py-3 my-4 sm:w-[24.5rem] w-64 border rounded-sm border-black hover:border-2 hover:border-black focus:outline-none"
                    placeholder="First Name"
                    type="text"
                  /></div>
                  <input
                    className="px-4 py-3 my-4 sm:w-[24rem] w-64  border rounded-sm border-black hover:border-2 hover:border-black focus:outline-none"
                ...
                <input
                  className="px-4 py-3 my-4 mb-4 sm:w-[50rem] w-64  border rounded-sm border-black hover:border-2 hover:border-black focus:outline-none"
                  placeholder="Address"
                  type="text"
                />                </div>
                                <div>
            ...
            <div className="flex gap-6 mt-8">
              ...
              <div>
                ...
                <div className="sm:w-[50rem] w-64  border border-gray-200 p-4">
                ...
                <div className="sm:w-[50rem] w-64  border border-gray-200 border-t-0 p-4">
                  <div className="flex gap-3">
                    <input
                      type="radio"
                      className="custom-radio"
            ...
            <div className="mt-8 gap-8">
              ...
              {isNoteVisible && (
                ...
                <br/>
                <input
                  className="px-4 py-3 my-4 sm:w-[50rem] w-64  ml-[3rem] border rounded-sm border-black hover:border-2 hover:border-black focus:outline-none"
            ...
            <hr className="border border-gray-200 sm:w-[53rem] my-8" />
            <div className="flex justify-between">
              <div className="flex gap-6" onClick={backButton}>
                <IoArrowBack className="mt-1"  />
                <p className="text-lg">Back</p>
              </div>
              <button className="sm:px-24 sm:py-2  px-5 py-0 h-12  bg-black text-white sm:mb-[6rem]">Place Order</button>
            </div>
          </div>
          <div>
            <hr className="border border-gray-200 sm:w-[30rem] my-8" />
            ...
            <hr className="border border-gray-200 sm:w-[30rem] my-4" />
            ...
            <hr className="border border-gray-200 my-4" />
            <div className="flex justify-between mb-[4rem] sm:mb-0">
