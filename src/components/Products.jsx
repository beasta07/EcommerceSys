...
const Products = () => {
  ...
  return (
    <div className='container md:mx-auto px-[2rem] '>
      <h1 className='font-bold text-center text-xl mt-16'>OUR PRODUCTS</h1>
      <div className='lg:block md:block hidden'>
      <div className='flex justify-center py-9 mb-2 lg:gap-[8rem] md:gap-16 '>
        <p>Handbags</p>
        <p>Jackets</p>
        <p>Shoes</p>
        <p>SweatShirts</p>
      ...
      <div className='sm:flex  gap-8 '>
        <div className='lg:w-[21rem] md:w-[21rem] md:lg:w-[21rem] relative group mb-[2rem]   ' onClick={handleCheckout}  >
          ...
          <img src='images/Dress2.jpg' className='transition-opacity duration-500 ease-in-out opacity-0 absolute top-0 left-0 lg:w-[21rem] md:w-[21rem]  group-hover:opacity-100' alt='Serenity Dress' />
        ...
        <div className='lg:w-[21rem] md:w-[21rem] relative group '  onClick={handleCheckout}>
          ...
          <img src='images/Shoes2.jpg' className='transition-opacity duration-500 ease-in-out opacity-0 absolute top-0 left-0 lg:w-[21rem] md:w-[21rem] group-hover:opacity-100' alt="Men's Patterned Oxford" />
        ...
        <div className='lg:w-[21rem] md:w-[21rem] relative group'  onClick={handleCheckout}>
          ...
          <img src='images/Glasses2.jpg' className='transition-opacity duration-500 ease-in-out opacity-0 absolute top-0 left-0 lg:w-[21rem] md:w-[21rem] group-hover:opacity-100' alt='Ocean Sea Salt For Aquariums' />
        ...
        <div className='lg:w-[21rem] md:w-[21rem] relative group'  onClick={handleCheckout}>
          ...
          <img src='images/Cardigan2.jpg' className='transition-opacity duration-500 ease-in-out opacity-0 absolute top-0 left-0 lg:w-[21rem] md:w-[21rem] group-hover:opacity-100' alt='In The Clouds Wrap Cardigans' />
